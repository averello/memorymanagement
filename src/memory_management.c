...
#define _MEMORY_MANAGEMENT_PROTOTYPE_INTERAL (memory_management_prototype_internal)
...
#define _MEMORY_MANAGEMENT_CANARY_ATTRIBUTE(o) _MEMORY_MANAGEMENT_INTERNAL_CAST(o)->_MEMORY_MANAGEMENT_CANARY_ATTRIBUTE_NAME
...
#define _MEMORY_MANAGEMENT_INVALID_RETAIN_COUNT (unsigned long long)(-1ULL)

#define _MEMORY_MANAGEMENT_RETAIN_COUNT_ATTRIBUTE(o) _MEMORY_MANAGEMENT_INTERNAL_CAST(o)->_MEMORY_MANAGEMENT_RETAIN_COUNT_ATTRIBUTE_NAME
...
#define _MEMORY_MANAGEMENT_DEALLOC_ATTRIBUTE(o) _MEMORY_MANAGEMENT_INTERNAL_CAST(o)->_MEMORY_MANAGEMENT_DEALLOC_ATTRIBUTE_NAME
#define _MEMORY_MANAGEMENT_CALL_DEALLOC(o) if (NULL != _MEMORY_MANAGEMENT_DEALLOC_ATTRIBUTE(o)) _MEMORY_MANAGEMENT_DEALLOC_ATTRIBUTE(o)(o)


static void _initMemoryManagement() __attribute__ ((constructor));

_MEMORY_MANAGEMENT_INTERNAL_TYPE {
	unsigned long long _MEMORY_MANAGEMENT_RETAIN_COUNT_ATTRIBUTE_NAME;
	unsigned long long _MEMORY_MANAGEMENT_CANARY_ATTRIBUTE_NAME;
	void (*_MEMORY_MANAGEMENT_DEALLOC_ATTRIBUTE_NAME)(void *);
};

_MEMORY_MANAGEMENT_INTERNAL_TYPE _MEMORY_MANAGEMENT_PROTOTYPE_INTERAL = {
	1ULL,
...
static void _initMemoryManagement() {
	memcpy(&MEMORY_MANAGEMENT_PROTOTYPE, &_MEMORY_MANAGEMENT_PROTOTYPE_INTERAL, sizeof(_MEMORY_MANAGEMENT_INTERNAL_TYPE));
}
...
void memory_management_attributes_set_dealloc_function(void *o, void (*deallocf)(void *)) {
	if (!_MEMORY_MANAGEMENT_CHECK_ENABLED(o) || _MEMORY_MANAGEMENT_IS_INVALIDATED(o))
		return;
	_MEMORY_MANAGEMENT_DECLARE_INTERNAL_VARIABLE(object) = _MEMORY_MANAGEMENT_INTERNAL_CAST(o);
...
#undef _MEMORY_MANAGEMENT_PROTOTYPE_INTERAL
